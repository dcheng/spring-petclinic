...
/**
 * Custom {@link AuthenticationSuccessHandler} that redirects OWNER-role users to their
 * own profile page after login.
 *
 * @author PetClinic contributors
 */
@Component
public class PetClinicAuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
